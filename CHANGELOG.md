...
* Added documentation for Mappls deeplinks.
* Added unit tests covering Mappls actions, exports, map modes, and map action interfaces.
* Updated the example app with a dedicated Mappls page and asset.
