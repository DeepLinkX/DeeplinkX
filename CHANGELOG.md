...
* Added Citymapper app with the following actions:
  * Open app
  * View map
  * Directions with coordinates
* Added Citymapper documentation, tests, public API coverage, catalog examples, map-selector support, and Android/iOS visibility configuration.
