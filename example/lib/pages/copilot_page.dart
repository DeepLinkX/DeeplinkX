...
/// Demonstrates deeplinks for CoPilot.
class CopilotPage extends StatefulWidget {
  /// Creates the CoPilot example page.
...
class _CopilotPageState extends State<CopilotPage> {
  ...
  final _destTitleController = TextEditingController(text: 'Warehouse');
  bool _fallback = true;
    ...
    body: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () async => _deeplinkX.launchApp(Copilot.open(fallbackToStore: _fallback)),
