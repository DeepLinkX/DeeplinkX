...
import 'package:deeplink_x_example/pages/sygic_truck_page.dart';
...
final _apps = <_DemoItem>[
  ...
  _DemoItem(title: 'Sygic Truck', assetName: 'assets/sygic_truck.png', builder: (_) => const SygicTruckPage()),
];
