...
void main() {
  group('home use cases', () {
    testWidgets('filter chips reveal every section', (final tester) async {
      ...
      expect(find.text('View all 32'), findsOneWidget);
      ...
      await tester.pump();
      expect(find.byType(AppTile), findsNWidgets(32));
  ...
  group('requested use cases', () {
    ...
    testWidgets('map selector validates coordinates and passes all providers in order', (final tester) async {
      ...
      expect(actions[12], isA<YandexMapsDirectionsWithCoordsAction>());
      expect(actions[13], isA<YandexNavigatorDirectionsWithCoordsAction>());
