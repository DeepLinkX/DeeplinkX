...
- **17 supported apps** — Facebook, Instagram, LinkedIn, WhatsApp, Telegram, Twitter, Threads, YouTube, TikTok, Pinterest, Zoom, Slack, Google Maps, Waze, Apple Maps, Sygic, TMAP.
...
| ------------------------------------- | ------------------------------------ |
| `launchMapViewAction`                 | Google Maps, Apple Maps, Waze, Sygic, TMAP |
| `launchMapSearchAction`               | Google Maps, Apple Maps, Waze        |
| `launchMapDirectionsAction`           | Google Maps, Apple Maps, Waze        |
| `launchMapDirectionsWithCoordsAction` | Google Maps, Apple Maps, Waze, Sygic, TMAP |
...
| TMAP        | [tmap.md](https://github.com/DeeplinkX/DeeplinkX/blob/master/doc/apps/tmap.md)               |
