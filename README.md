...
- **Maps & navigation** — open a location, search a place, or launch turn-by-turn directions in Google Maps, Amap, Baidu Maps, NAVER Map, 2GIS, Tencent Maps, Yandex Maps, Yandex Navigator, Apple Maps, Waze, Sygic, Moovit, Air Navigation Pro, Mappls, or Neshan; list your preferred apps and DeeplinkX opens the first installed one, falling back to the web map otherwise.
- **One package, every platform** — iOS, Android, macOS, Windows, Linux, and Web.

Out of the box: **32 apps**, including **15 navigation providers** (ChatGPT, Netflix, Temu, Snapchat, CapCut, Facebook, Instagram, LinkedIn, WhatsApp, Telegram, Twitter, Threads, YouTube, TikTok, Pinterest, Zoom, Slack, Google Maps, Amap, Baidu Maps, NAVER Map, 2GIS, Tencent Maps, Yandex Maps, Yandex Navigator, Waze, Apple Maps, Sygic, Moovit, Air Navigation Pro, Mappls, Neshan), and **7 stores** (iOS App Store, Mac App Store, Microsoft Store, Google Play, Huawei AppGallery, Cafe Bazaar, Myket).
...
| ------------------------------------- | ------------------------------------ |
| `launchMapViewAction`                 | Google Maps, Amap, Baidu Maps, NAVER Map, 2GIS, Tencent Maps, Yandex Maps, Yandex Navigator, Apple Maps, Waze, Sygic, Moovit, Air Navigation Pro, Mappls, Neshan |
...
| `launchMapDirectionsWithCoordsAction` | Google Maps, Amap, Baidu Maps, NAVER Map, 2GIS, Tencent Maps, Yandex Maps, Yandex Navigator, Apple Maps, Waze, Sygic, Moovit, Air Navigation Pro, Mappls, Neshan |
...
| ---------------------------------- | ------------------------------ | -------------------------------------------------- |
| **Typed API for popular apps**     | ✅ 32 apps, no URL maintenance | ❌ Raw URLs only                                   |
