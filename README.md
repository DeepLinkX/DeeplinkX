...
await deeplinkX.launchMapViewAction(
  actions: [
    ...
    KakaoMap.view(coordinate: origin),
...
await deeplinkX.launchMapDirectionsWithCoordsAction(
  actions: [
    ...
    KakaoMap.directionsWithCoords(destination: destination),
...
| ------------------------------------- | ------------------------------------ |
| `launchMapViewAction`                 | Google Maps, Amap, Baidu Maps, NAVER Map, 2GIS, Tencent Maps, Yandex Maps, Yandex Navigator, Apple Maps, Waze, Sygic, Moovit, KakaoMap, Neshan |
...
| `launchMapDirectionsWithCoordsAction` | Google Maps, Amap, Baidu Maps, NAVER Map, 2GIS, Tencent Maps, Yandex Maps, Yandex Navigator, Apple Maps, Waze, Sygic, Moovit, KakaoMap, Neshan |
...
|                | KakaoMap          | View map, directions with coordinates                                           |
...
[KakaoMap](https://github.com/DeeplinkX/DeeplinkX/blob/master/doc/apps/kakao_map.md) ·
