...
await deeplinkX.launchMapViewAction(
  actions: [
    ...
    TomTomGoFleet.view(coordinate: origin),
...
| ------------------------------------- | ------------------------------------ |
| `launchMapViewAction`                 | Google Maps, Amap, Baidu Maps, NAVER Map, 2GIS, Tencent Maps, Yandex Maps, Yandex Navigator, Apple Maps, Waze, Sygic, Moovit, TomTom Go Fleet, Neshan |
...
| `launchMapDirectionsWithCoordsAction` | Google Maps, Amap, Baidu Maps, NAVER Map, 2GIS, Tencent Maps, Yandex Maps, Yandex Navigator, Apple Maps, Waze, Sygic, Moovit, TomTom Go Fleet, Neshan |
...
|                | TomTom Go Fleet   | View map, directions with coordinates                                           |
...
[TomTom Go Fleet](https://github.com/DeeplinkX/DeeplinkX/blob/master/doc/apps/tomtom_go_fleet.md) ·
