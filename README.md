...
await deeplinkX.launchMapViewAction(
  actions: [
    ...
    TomTomGo.view(coordinate: origin),
...
await deeplinkX.launchMapDirectionsWithCoordsAction(
  actions: [
    ...
    TomTomGo.directionsWithCoords(destination: destination),
...
| ------------------------------------- | ------------------------------------ |
| `launchMapViewAction`                 | Google Maps, Amap, Baidu Maps, NAVER Map, 2GIS, Tencent Maps, Yandex Maps, Yandex Navigator, Apple Maps, Waze, Sygic, Moovit, TomTom Go, Neshan |
...
| `launchMapDirectionsWithCoordsAction` | Google Maps, Amap, Baidu Maps, NAVER Map, 2GIS, Tencent Maps, Yandex Maps, Yandex Navigator, Apple Maps, Waze, Sygic, Moovit, TomTom Go, Neshan |
...
|                | TomTom Go         | View map, directions with coordinates                                           |
...
[TomTom Go](https://github.com/DeeplinkX/DeeplinkX/blob/master/doc/apps/tomtom_go.md) ·
