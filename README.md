...
await deeplinkX.launchMapViewAction(
  actions: [
    ...
    HereWeGo.view(coordinate: origin),
...
await deeplinkX.launchMapDirectionsWithCoordsAction(
  actions: [
    ...
    HereWeGo.directionsWithCoords(destination: destination),
...
| ------------------------------------- | ------------------------------------ |
| `launchMapViewAction`                 | Google Maps, Amap, Baidu Maps, NAVER Map, 2GIS, Tencent Maps, Yandex Maps, Yandex Navigator, Apple Maps, Waze, Sygic, Moovit, HERE WeGo, Neshan |
...
| `launchMapDirectionsWithCoordsAction` | Google Maps, Amap, Baidu Maps, NAVER Map, 2GIS, Tencent Maps, Yandex Maps, Yandex Navigator, Apple Maps, Waze, Sygic, Moovit, HERE WeGo, Neshan |
...
|                | HERE WeGo         | View map, directions with coordinates                                           |
...
[HERE WeGo](https://github.com/DeeplinkX/DeeplinkX/blob/master/doc/apps/here_wego.md) ·
