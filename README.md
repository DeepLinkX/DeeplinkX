...
Out of the box: **19 apps** (Netflix, Facebook, Instagram, LinkedIn, WhatsApp, Telegram, Twitter, Threads, YouTube, TikTok, Pinterest, Zoom, Slack, Google Maps, Amap, Waze, Apple Maps, Sygic, Neshan) and **7 stores** (iOS App Store, Mac App Store, Microsoft Store, Google Play, Huawei AppGallery, Cafe Bazaar, Myket).
...
| **Entertainment** | Netflix        | Open title, watch title                                                         |
...
**Apps:** [Netflix](https://github.com/DeeplinkX/DeeplinkX/blob/master/doc/apps/netflix.md) ·
