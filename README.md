...
- **Maps & navigation** — open a location, search a place, or launch turn-by-turn directions in Google Maps, Amap, Baidu Maps, 2GIS, Apple Maps, Waze, Sygic, Moovit, or Neshan; list your preferred apps and DeeplinkX opens the first installed one, falling back to the web map otherwise.
- **One package, every platform** — iOS, Android, macOS, Windows, Linux, and Web.

Out of the box: **21 apps** (Facebook, Instagram, LinkedIn, WhatsApp, Telegram, Twitter, Threads, YouTube, TikTok, Pinterest, Zoom, Slack, Google Maps, Amap, Baidu Maps, 2GIS, Waze, Apple Maps, Sygic, Moovit, Neshan) and **7 stores** (iOS App Store, Mac App Store, Microsoft Store, Google Play, Huawei AppGallery, Cafe Bazaar, Myket).
...
| ------------------------------------- | ------------------------------------ |
| `launchMapViewAction`                 | Google Maps, Amap, Baidu Maps, 2GIS, Apple Maps, Waze, Sygic, Moovit, Neshan |
...
| `launchMapDirectionsWithCoordsAction` | Google Maps, Amap, Baidu Maps, 2GIS, Apple Maps, Waze, Sygic, Moovit, Neshan |
...
| ---------------------------------- | ------------------------------ | -------------------------------------------------- |
| **Typed API for popular apps**     | ✅ 21 apps, no URL maintenance | ❌ Raw URLs only                                   |
