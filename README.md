...
- **17 supported apps** — Facebook, Instagram, LinkedIn, WhatsApp, Telegram, Twitter, Threads, YouTube, TikTok, Pinterest, Zoom, Slack, Google Maps, Waze, Apple Maps, Sygic, NAVER Map.
...
await deeplinkX.launchMapViewAction(
  actions: [
    ...
    NaverMap.view(coordinate: origin),
  ],
);
...
await deeplinkX.launchMapDirectionsWithCoordsAction(
  actions: [
    ...
    NaverMap.directionsWithCoords(destination: destination),
  ],
);
```
...
| ------------------------------------- | --------------------------------------------------- |
| `launchMapViewAction`                 | Google Maps, Apple Maps, Waze, Sygic, NAVER Map     |
| `launchMapSearchAction`               | Google Maps, Apple Maps, Waze                       |
| `launchMapDirectionsAction`           | Google Maps, Apple Maps, Waze                       |
| `launchMapDirectionsWithCoordsAction` | Google Maps, Apple Maps, Waze, Sygic, NAVER Map     |
...
|                | NAVER Map         | View map, directions with coordinates                                           |
...
For NAVER Map, declare `<string>nmap</string>` on iOS and `<package android:name="com.nhn.android.nmap" />` on Android.
...
| NAVER Map   | [naver_map.md](https://github.com/DeeplinkX/DeeplinkX/blob/master/doc/apps/naver_map.md)     |
