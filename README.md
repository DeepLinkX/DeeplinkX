...
| ------------------------------------- | ------------------------------------ |
| `launchMapViewAction`                 | Google Maps, Amap, Baidu Maps, NAVER Map, 2GIS, Tencent Maps, Yandex Maps, Yandex Navigator, Apple Maps, Waze, Sygic, Sygic Truck, Moovit, Neshan |
...
| `launchMapDirectionsWithCoordsAction` | Google Maps, Amap, Baidu Maps, NAVER Map, 2GIS, Tencent Maps, Yandex Maps, Yandex Navigator, Apple Maps, Waze, Sygic, Sygic Truck, Moovit, Neshan |
