...
await deeplinkX.launchMapDirectionsWithCoordsAction(
  actions: [
    ...
    OsmAnd.directionsWithCoords(destination: destination),
...
| ------------------------------------- | ------------------------------------ |
| `launchMapViewAction`                 | Google Maps, Amap, Baidu Maps, NAVER Map, 2GIS, Tencent Maps, Yandex Maps, Yandex Navigator, Apple Maps, Waze, Sygic, Moovit, OsmAnd, Neshan |
...
| `launchMapDirectionsWithCoordsAction` | Google Maps, Amap, Baidu Maps, NAVER Map, 2GIS, Tencent Maps, Yandex Maps, Yandex Navigator, Apple Maps, Waze, Sygic, Moovit, OsmAnd, Neshan |
...
|                | OsmAnd            | View map, directions with coordinates                                           |
...
[OsmAnd](https://github.com/DeeplinkX/DeeplinkX/blob/master/doc/apps/osmand.md) ·
