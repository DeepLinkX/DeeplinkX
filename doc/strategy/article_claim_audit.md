...
| DeeplinkX supports web fallback | `lib/src/core/deeplink_x.dart`, `doc/apps/telegram.md`, `doc/apps/google_maps.md` | Verified | Validate examples per provider |
...
| DeeplinkX has reliable provider-specific behavior | `test/src/apps/telegram_test.dart`, `test/src/apps/google_maps_test.dart`, `test/src/apps/whatsapp_test.dart` | Verified | Add more test references as needed |
