...
Post-merge note: v1.3.6 added Baidu Maps after this snapshot. Baidu Maps rankings are intentionally not included in this dated report and should be captured in the next keyword refresh.
...
- Supported-app keyword coverage was cross-checked against the README app list and `doc/apps/*.md` available during this snapshot; the app-specific matrix covers those app docs, including newer map/navigation providers such as Amap, Moovit, and Neshan.
...
- Recheck Baidu Maps plain-name, link, deeplink, search, directions, coordinates, nearby search, transit line, and navigation queries after v1.3.6 is indexed.
